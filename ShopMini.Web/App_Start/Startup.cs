...
[assembly: OwinStartup(typeof(ShopMini.Web.App_Start.Startup))]

namespace ShopMini.Web.App_Start
{
    public class Startup
    {
        ...
        private void ConfigAutofac(IAppBuilder app)
        {
            ...
            builder.RegisterType<MiniShopDbContext>().AsSelf().InstancePerRequest();
